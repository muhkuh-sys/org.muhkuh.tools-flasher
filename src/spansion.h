...
#define __SPANSION_H
  ...
  // unlock bypass 
  #define SPANSION_ADR_UNLOCKBYPASS_CYCLE0      0x555U
  #define SPANSION_CMD_UNLOCKBYPASS_CYCLE0      0xAAU
  #define SPANSION_ADR_UNLOCKBYPASS_CYCLE1      0x2AAU
  #define SPANSION_CMD_UNLOCKBYPASS_CYCLE1      0x55U
  #define SPANSION_ADR_UNLOCKBYPASS_CYCLE2      0x555U
  #define SPANSION_CMD_UNLOCKBYPASS_CYCLE2      0x20U

  #define SPANSION_ADR_UNLOCKBYPASSPRG          0
  #define SPANSION_CMD_UNLOCKBYPASSPRG          0xA0U
  
  #define SPANSION_ADR_UNLOCKBYPASSRESET_CYCLE0 0
  #define SPANSION_CMD_UNLOCKBYPASSRESET_CYCLE0 0x90U
  #define SPANSION_ADR_UNLOCKBYPASSRESET_CYCLE1 0
  #define SPANSION_CMD_UNLOCKBYPASSRESET_CYCLE1 0x00U
