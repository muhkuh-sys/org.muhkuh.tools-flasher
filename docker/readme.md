...
On Linux, the MBS build container can be started with the compose.yml file,
which will map the Linux user and current working directory to be the same as the host.
...
docker compose -f compose-windows.yml exec build bash
```
